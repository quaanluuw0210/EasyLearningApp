              ...
              {topics.map((topic) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-xl px-3.5 py-2.5 text-left text-sm transition-all duration-150 ${isActive
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {topic.totalWords ? (
                        <span
                          className={`shrink-0 rounded-md px-2 py-0.5 text-[10px] font-medium transition ${isActive
